          ...
          {AXIOMS.map((axiom, idx) => (
            ...
            >
              ...
              <div className="absolute left-4 md:left-8 top-3 -translate-x-1/2 flex items-center justify-center">
                <div className="w-3 h-3 rounded-full bg-[#0A0B0B] border border-[#4B5563] group-hover:border-[#D4AF37] flex items-center justify-center transition-colors">
                  <div className="w-1 h-1 rounded-full bg-[#D4AF37]/90" />
                </div>
              </div>

              {/* Axiom Number */}
              <div className="font-mono-code text-xs tracking-[0.3em] text-[#6B7280] mb-2">
                AXIOM {axiom.number}
              </div>
              ...
              <div className="inline-flex items-center gap-2 text-[11px] font-mono-code text-[#D1D5DB] bg-[#0E1012] px-3 py-1 border border-[#1F2937]">
